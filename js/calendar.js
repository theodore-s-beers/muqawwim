...
function anneeDeLaRevolution (jd) {
  ...
  const adr = Math.round((lasteq - FRENCH_REVOLUTIONARY_EPOCH) / TropicalYear) + 1
...
function calcHebrew () { // eslint-disable-line no-unused-vars
  setJulian(
    hebrewToJd(
...
function calcIslamic () { // eslint-disable-line no-unused-vars
  setJulian(
    islamicToJd(
...
function calcPersian () { // eslint-disable-line no-unused-vars
  setJulian(
    persianToJd(
...
function calcPersiana () { // eslint-disable-line no-unused-vars
  setJulian(
    persianaToJd(
...
function calcMayanCount () { // eslint-disable-line no-unused-vars
  setJulian(
    mayanCountToJd(
...
function calcIndianCivilCalendar () { // eslint-disable-line no-unused-vars
  setJulian(
    indianCivilToJd(
...
function calcFrench () { // eslint-disable-line no-unused-vars
  let decade, j, mois
...
function calcGregSerial () { // eslint-disable-line no-unused-vars
...
function presetDataToRequest (s) { // eslint-disable-line no-unused-vars
  const eq = s.indexOf('=')
  let set = false
  if (eq !== -1) {
    ...
    if (calendar.toLowerCase() === 'gregorian') {
      ...
      if (d != null) {
        ...
        console.log('Invalid Julian calendar date "' + date + '" in search request')
      }
      ...
      if (d != null) {
        ...
        console.log('Invalid Modified Julian day "' + date + '" in search request')
      }
